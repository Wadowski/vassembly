...
import * as taskCommentDomain from '@vassembly/domain-task-comment';
...
import { registerTaskActivityResolvers } from './resolvers/taskActivity';
import { registerTaskPlanResolvers } from './resolvers/taskPlan';
...
taskCommentDomain.gqlSchema(builder);
...
registerTaskActivityResolvers(builder);
