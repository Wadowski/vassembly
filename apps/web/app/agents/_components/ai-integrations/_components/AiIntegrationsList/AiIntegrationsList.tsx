  ...
  const columns = useMemo(
    () =>
      getAiIntegrationListTableColumns({
        ...
        onSetSystemAgentPreference: catalog.handleSetSystemAgentPreference,
        testingCredentialId: catalog.testingCredentialId,
        currentPreferenceCredentialId: catalog.currentPreferenceCredentialId,
        settingPreferenceCredentialId: catalog.settingPreferenceCredentialId,
        isPreferenceLoading: catalog.isPreferenceLoading,
        isSettingPreference: catalog.isSettingPreference,
      }),
    [
      catalog.currentPreferenceCredentialId,
      catalog.handleNavigateEdit,
      catalog.handleSetSystemAgentPreference,
      catalog.handleTestConnection,
      catalog.isPreferenceLoading,
      catalog.isSettingPreference,
      catalog.openDeleteFor,
      catalog.openRestoreFor,
      catalog.settingPreferenceCredentialId,
